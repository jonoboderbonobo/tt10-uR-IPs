...
T {Supply Voltage: @spice_get_voltage(vcc)\\V} -210 -1170 0 0 0.4 0.4 {floater=true layer=3}
T {			Circuit Information
__________________________________________________} -300 -1230 0 0 0.4 0.4 { layer=3
}
...
N 880 -1000 880 -960 {lab=Vin1}
N 880 -900 880 -840 {lab=#net10}
...
C {ngspice_get_expr.sym} -30 -1120 2 0 {name=r6 node="[expr \{[ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)]\}]"
descr="Voltage drop at Resistor ="}
C {ngspice_get_expr.sym} -30 -1030 2 0 {name=r7 node="[to_eng [expr \{([ngspice::get_voltage v(vin1)] - [ngspice::get_voltage v(vout)])/ [ngspice::get_voltage i(vi_total)]\}]]"
descr="Resistance ="}
C {ngspice_get_expr.sym} -30 -1080 2 0 {name=r8 node="[to_eng [ngspice::get_voltage i(vi_total)]]"
...
C {lab_pin.sym} 880 -1000 2 1 {name=p2 lab=Vin1}
