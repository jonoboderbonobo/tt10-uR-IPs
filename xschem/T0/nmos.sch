...
S {}
E {}
B 2 797.5 -772.5 1357.5 -442.5 {flags=graph
...
i(vi_i3)"
x1=0.18}
B 2 797.5 -1162.5 1357.5 -832.5 {flags=graph
...
node=v(vgs)
rainbow=0}
B 2 797.5 -387.5 1357.5 -57.5 {flags=graph
...
B 2 800 -12.5 1360 317.5 {flags=graph
...
B 2 805 377.5 1365 707.5 {flags=graph
...
T {Output} 1017.5 -812.5 0 0 0.6 0.6 { layer=6}
T {Select Voltage} 967.5 -1202.5 0 0 0.6 0.6 { layer=6}
T {Transient Analysis} 3197.5 -920 0 0 0.6 0.6 { layer=6}
T {Transconductance} 927.5 -427.5 0 0 0.6 0.6 { layer=6}
T {Threshold Voltage} 930 -52.5 0 0 0.6 0.6 { layer=6}
T {Cox/WL = Cgg = Cgs + Cgd + Cgb} 830 -1420 0 0 0.4 0.4 {floater=true layer=3}
T {Drain-Source Transconductance} 815 337.5 0 0 0.6 0.6 { layer=6}
...
.control
  ...
  dc v_dev_vds 0 1.8  0.01 
  *dc v_dev_vds 0 20u  10n 
  *v_dev_vgs 1 1.8 0.02
  write nmos_tb.raw
...
descr="vi_d="}
C {devices/lab_pin.sym} -130 -810 2 0 {name=p5 lab=Vgs}
C {devices/lab_pin.sym} -190 -720 0 0 {name=p2 lab=0}
...
C {devices/vsource.sym} -190 -600 0 0 {name=v_dev_vds value=1.8}
...
C {ngspice_get_value.sym} 970 -1360 0 1 {name=r9 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgg]
descr="Cgg="
...
C {ngspice_get_value.sym} 1050 -1360 0 1 {name=r12 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgs]
descr="Cgs="

}
C {ngspice_get_value.sym} 1130 -1360 0 1 {name=r13 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgd]
descr="Cgd="

}
C {ngspice_get_value.sym} 1210 -1360 0 1 {name=r14 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[cgb]
descr="Cgb="
...
C {ngspice_get_value.sym} 1460 -1410 0 1 {name=r17 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[leff])
descr="effective length="

}
C {ngspice_get_value.sym} 1460 -1370 0 1 {name=r18 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[weff])
descr="effective width="

}
C {ngspice_get_value.sym} 700 -1125 0 1 {name=r19 node=@m.xm1.msky130_fd_pr__nfet_01v8_lvt[gds]
descr="gds="
...
descr="vi_d="}
C {ngspice_get_value.sym} 1330 -1410 0 1 {name=r22 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[l])
descr="length="

}
C {ngspice_get_value.sym} 1330 -1370 0 1 {name=r23 node=v(@m.xm1.msky130_fd_pr__nfet_01v8_lvt[w])
descr="width="

}
C {vsource.sym} -190 -750 0 0 {name=v_dev_vgs
value=0.8
