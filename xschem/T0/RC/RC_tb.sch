...
S {}
E {}
B 2 3580 -775 4140 -445 {flags=graph,unlocked
...
B 2 3580 -435 4140 -115 {flags=graph,unlocked
...
color=7
node=v(vineff)}
B 2 2900 -550 3530 -340 {flags=graph,unlocked
...
autoload=1
xrawfile=$netlist_dir/cmos_example_ngspice.raw}
B 2 2900 -770 3530 -560 {flags=graph,unlocked
...
autoload=1
xrawfile=$netlist_dir/cmos_example_ngspice.raw}
B 2 3580 -105 4140 165 {flags=graph,unlocked
...
color=16
node=vin1}
B 2 1455 -90 2085 190 {flags=graph,unlocked
...
color=4
node=v(vout2)}
B 2 1455 200 2085 480 {flags=graph,unlocked
...
B 2 1455 500 2085 780 {flags=graph,unlocked
...
color=12
node=i(vi_iin)}
B 2 1455 790 2085 1070 {flags=graph,unlocked
...
color=12
node=i(vi_ib)}
B 2 2095 500 2725 780 {flags=graph,unlocked
...
color=12
node=i(vi_icp)}
B 2 2095 790 2725 1070 {flags=graph,unlocked
...
color=12
node=i(vi_id)}
B 2 2735 500 3365 780 {flags=graph,unlocked
...
T {AC Analysis} 2910 -820 0 0 0.6 0.6 { layer=6}
T {Transient Analysis} 1455 -1020 0 0 0.6 0.6 { layer=6}
T {DC Analysis} 3580 -815 0 0 0.6 0.6 { layer=6}
...
T {M} 1440 -48.20322127728451 0 1 0.6 0.6 { layer=3}
N 750 -390 810 -390 {lab=#net1}
N 860 -390 890 -390 {lab=VSS}
N 890 -390 970 -390 {lab=VSS}
N 430 -530 430 -390 {lab=Vineff}
N 430 -480 500 -480 {lab=Vineff}
N 430 -390 470 -390 {lab=Vineff}
N 530 -390 610 -390 {lab=#net2}
...
device=resistor
m=1}
C {sky130_fd_pr/nfet_01v8.sym} 410 -560 0 0 {name=M1
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {lab_pin.sym} 430 -590 2 1 {name=p4 lab=VCC}
C {lab_pin.sym} 430 -560 2 0 {name=p5 lab=0}
C {ammeter.sym} 500 -390 3 1 {name=vi_iin}
C {lab_pin.sym} 500 -480 2 0 {name=p1 lab=Vineff}
C {lab_pin.sym} 390 -560 2 1 {name=p3 lab=Vin1}
C {ammeter.sym} 640 -390 3 1 {name=vi_iin2}
C {ngspice_get_value.sym} 470 -610 0 1 {name=r1 node=@$\{path\}m1[gm]
descr="gm="}
...
C {devices/lab_pin.sym} 220 -250 0 0 {name=p32 lab=VCC}
...
C {devices/lab_pin.sym} 970 -390 2 0 {name=p2 lab=VSS}
